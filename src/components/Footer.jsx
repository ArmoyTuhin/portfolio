...
const Footer = () => {
  ...
  return (
    <footer className="bg-black border-t-2 border-white/10 py-12 relative" style={{boxShadow: '0 -4px 20px rgba(255, 255, 255, 0.05)'}}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center">
          {/* Back to Top Button */}
          <button
            onClick={scrollToTop}
            className="mb-8 w-12 h-12 bg-white/10 text-white rounded-full flex items-center justify-center border-2 border-white/20 hover:bg-white hover:text-black transition-all group"
          ...
          {/* Name and Title */}
          <div className="mb-8">
            <h3 className="text-2xl font-bold mb-2 text-white font-mono sci-fi-glow">TUHIN CHOWDHURY</h3>
            <p className="text-gray-400 font-mono">Computer Science Engineer & Researcher</p>
          </div>
          ...
          {/* Divider */}
          <div className="w-full h-px bg-white/10 mb-8" style={{boxShadow: '0 0 10px rgba(255, 255, 255, 0.1)'}}></div>
